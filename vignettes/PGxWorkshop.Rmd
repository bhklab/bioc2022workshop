...
their domain specific use case, for example drug in `r PGx` and radiation
in `r RGx`. Correspondingly, the "sample" slot was named cell and corresponded
to _in vitro_ immortalized human cancer cell-lines.
...
the results of diverse multi-omic profiling experiments, including mutation,
...
phenotype data within a `CoreSet` and `PharmacoSet`.
